...
public class TempBanCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        target.kickPlayer("§c§lᴘᴜɴɪꜱʜᴍᴇɴᴛꜱ §8• §cYou have been temporarily banned. Reason: " + reason + " Duration: " + formatDuration(duration));
        sender.sendMessage("§c§lᴘᴜɴɪꜱʜᴍᴇɴᴛꜱ §8• §cPlayer " + target.getName() + " has been temporarily banned for " + formatDuration(duration));

        Bukkit.getScheduler().runTaskLater(Punishments.getInstance(), () -> {
